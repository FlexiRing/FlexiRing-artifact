...
am_hal_rtc_time_t hal_time = {0};

uint64_t am_bsp_rtc_getUnixTime(void)
{
    struct tm stm;
    ...
    stm.tm_year=hal_time.ui32Year+100;
    stm.tm_mon=hal_time.ui32Month-1;
    stm.tm_mday=hal_time.ui32DayOfMonth;
    stm.tm_hour=hal_time.ui32Hour;
    stm.tm_min=hal_time.ui32Minute;
    stm.tm_sec=hal_time.ui32Second;

    am_util_stdio_printf("%u -- ",mktime(&stm));
